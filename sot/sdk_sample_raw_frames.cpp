    ...
    const char* a_strVideoPath)
{
    ...
    // Set SOT tracking to a bounding box
    pStream->getSingleObjectTracker().TrackBoundingBox(100, 100, 120, 120); // X1 = 100, Y1 = 100, X2 = 120, Y2 = 120
    // Set SOT tracking to a point (stops the previous track and starts a new one)
    pStream->getSingleObjectTracker().TrackPoint(100, 100); // X = 100, Y = 100
    // Stop SOT tracking
    pStream->getSingleObjectTracker().StopTracking();
